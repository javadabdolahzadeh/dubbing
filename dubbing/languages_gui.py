...
language_data = {
    "english": {
        ...
        Upload a video, subtitle, audio file or provide a URL video link. 📽️ **Gets the updated notebook from the official repository.: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing supports different TTS (Text-to-Speech) engines, which are:**
    ...
    "spanish": {
        ...
        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing admite diferentes motores de TTS (Texto a Voz), los cuales son:**
    ...
    "french": {
        ...
        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
    ...
    "german": {
        ...
        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
    ...
    "italian": {
        ...
        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing supporta diversi motori TTS (Text-to-Speech), tra cui:**
    ...
    "japanese": {
        ...
        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbingはさまざまなTTS（テキスト読み上げ）エンジンをサポートしています。これらは次のとおりです:**
    ...
    "chinese_zh_cn": {
        "description": """
          ...
          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
    ...
    "ukrainian": {
        "description": """
        ### 🎥 **Перекладайте відео легко з dubbing!** 📽️

        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing підтримує різні двигуни TTS (текст-у-мову), які є:**
    ...
    "arabic": {
        "description": """
          ### 🎥 **ترجمة مقاطع الفيديو بسهولة مع dubbing!** 📽️

          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        "tutorial": """
          ...
          # 🧩 **يدعم dubbing محركات TTS (نص إلى كلام) مختلفة، وهي:**
    ...
    "russian": {
        ...
        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing поддерживает различные движки TTS (текст в речь), которые включают:**
    ...
    "turkish": {
        ...
        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing, farklı TTS (Metin-okuma-sesi) motorlarını destekler, bunlar:**
    ...
    "indonesian": {
        ...
        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing mendukung berbagai mesin TTS (Teks-ke-Suara), yaitu:**
    ...
    "portuguese": {
        ...
        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing suporta diferentes motores TTS (Texto para Fala), que são:**
    ...
    "hindi": {
        "description": """
          ...
          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        "tutorial": """
          ...
          # 🧩 **dubbing विभिन्न TTS (टेक्स्ट-टू-स्पीच) इंजनों का समर्थन करता है, जो हैं:**
    ...
    "vietnamese": {
        ...
        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing hỗ trợ các công cụ TTS (Text-to-Speech) khác nhau, bao gồm:**
    ...
    "polish": {
        ...
        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing obsługuje różne silniki TTS (tekst do mowy), które to:**
    ...
    "swedish": {
        ...
        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing stöder olika TTS (Text-to-Speech) motorer, vilka är:**
    ...
    "korean": {
        ...
        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing는 다양한 TTS (텍스트 음성 변환) 엔진을 지원합니다. 이는 다음과 같습니다:**
    ...
    "marathi": {
        ...
        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
    ...
    "azerbaijani": {
        ...
        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **dubbing-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing, fərqli TTS (Mətnə Səsləndirmə) mühərriklərini dəstəkləyir ki, onlar:**
    ...
    "persian": {
        ...
        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing از موتورهای مختلف TTS (متن به گفتار) پشتیبانی می‌کند، که شامل:**
    ...
    "afrikaans": {
        ...
        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [dubbing](https://github.com/javadabdolahzadeh/dubbing)!**
        ...
        # 🧩 **dubbing ondersteun verskillende TTS (Teks-na-Spraak) enjins, wat is:**
